...
req = requests.post('http://127.0.0.1:5000/updateProfile/api/update', json=json_obj, headers=headers)
print(req.json())

##For GetProfile
req = requests.post('http://127.0.0.1:5000/profile/api/getProfile', headers=headers)
print(json.dumps(req.json(), indent=3))

#####METHOD NOT ALLOWED#######
req =requests.get("http://127.0.0.1:5000/profile/api/getProfile", headers=headers)
print(req.json())